...
// updated by: EarthSalamander42, 2021
...
//			if (DUPLICATE_TOKEN == "item")
//				console.log(key.indexOf(DUPLICATE_TOKEN))

			if(DUPLICATE_TOKEN && key.indexOf(DUPLICATE_TOKEN) > -1) {
				key = key + duplicate;
				duplicate++;
//				console.log(key)
//				console.log(val);
